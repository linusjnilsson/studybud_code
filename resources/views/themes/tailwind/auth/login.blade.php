                ...
                <form action="#" method="POST">
                    ...
                    <div>
                        ...
                        @if(setting('auth.email_or_username') && setting('auth.email_or_username') == 'username')
                            <label for="username" class="block text-sm font-medium leading-5 text-gray-700">Brukernavn</label>
                            ...
                            @endif
                        @else
                            <label for="email" class="block text-sm font-medium leading-5 text-gray-700">E-post</label>
                            <div class="mt-1 rounded-md shadow-sm">
